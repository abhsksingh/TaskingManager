...
Live Demo: https://taskingmanager-production.up.railway.app
...
|---------|-------|--------|
| View all projects | Yes | No (own only) |
| Create projects | Yes | Yes |
| Delete any project | Yes | No |
| Add project members | Yes | Project Admin only |
| View all tasks | Yes | No (own only) |
| Create/edit tasks | Yes | Yes |
| Delete tasks | Yes | Yes |
| View team page | Yes | No |
| View all activity | Yes | No |
